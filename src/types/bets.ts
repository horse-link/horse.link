...
export type BetStatus = "RESULTED" | "PENDING" | "SETTLED" | "UNKNOWN";
...
export type Filters = "createdAt_gte" | "settledAt_gte";

export type FilterObject = Record<Filters, string | number>;

    ...
    <RegisterLayoutPage>
      ...
      <div>
        ...
        <input
          type="number"
          placeholder="0"
          className="mb-6 w-full rounded-md border-b-[0.12rem] border-black pl-1 pt-1 transition-colors duration-100 disabled:bg-white disabled:text-black/50"
        />
        ...
        <h1 className="mb-5">
          If you are an advanced user you can use your MetaMask Wallet otherwise
          for first time users just use the generated wallet pre-populated
          above.{" "}
        </h1>

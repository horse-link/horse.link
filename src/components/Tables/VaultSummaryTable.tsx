...
export const VaultSummaryTable: React.FC<Props> = ({
  headers,
  headerStyles,
  rows,
  rowStyles
    ...
    <tbody className="flex flex-col divide-y divide-hl-border px-4">
      {rows.map((row, i) => (
        ...
        >
          ...
          <td className={classNames("col-span-2")} key={`table-row-data-2`}>
            {row[2]}
          </td>
          <td className={classNames("col-span-2")} key={`table-row-data-3`}>
            {row[3]}
          </td>
          <td className={classNames("col-span-4")} key={`table-row-data-4`}>
            {row[4]}
          </td>
        </tr>
      ))}
